#!/usr/bin/env python3
"""
Training script for cursor and keyboard control using LoRA fine-tuning
...
class CursorKeyboardTrainer:
    def __init__(self, model_name="microsoft/Phi-3.6-mini-instruct", output_dir="./cursor_keyboard_lora"):
...
def main():
    ...
    os.makedirs("./cursor_keyboard_lora", exist_ok=True)
    
    # Initialize and run trainer
    trainer = CursorKeyboardTrainer()
